...
// Since we can only store inis in the same folder as the game executable, we'll use a text file instead.
...
// CPU:
file_text_write_string(dfile, string(global.cpu_id ^ dkey));
file_text_writeln(dfile);
