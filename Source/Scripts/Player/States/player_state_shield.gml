...
if (shield == noone || shield_obj == noone || invincibility > 1)
{
    exit;
}
...
if (shield == SHIELD_FIRE && player_index == CHAR_SONIC)
{
    if (shield_usable)
    {
        if (input_action_pressed)
        {
            ...
            audio_play_sound(SFX._shield_use_flame, global.sfx_volume, 1, 0, 0);
        }
    }
...
if (shield == SHIELD_BUBBLE && player_index == CHAR_SONIC)
{
    ...
    if (shield_state == 1 && ground)
    {
        ...
        audio_play_sound(SFX._shield_use_bubble, global.sfx_volume, 1, 0, 0);
    }
...
if (shield == SHIELD_ELECTRICITY && player_index == CHAR_SONIC)
{
    if (shield_usable)
    {
        if (input_action_pressed)
        {
            ...
            shield_usable  = false;
            jump_lock      = false;
            audio_play_sound(SFX._shield_use_electricity, global.sfx_volume, 1, 0, 0);
            ...
            for (i = 0; i < 4; i += 1)
            {
                ...
                switch (i)
                {
                    ...
                    case 1:
                    {
                        _spark._direction = 180;
                        break;
                    }
                    case 2:
                    {
                        _spark._direction = 224;
                        break;
                    }
                    case 3:
                    {
                        _spark._direction = 315;
                        break;
                    }
                }
            }
