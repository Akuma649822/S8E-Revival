...
else if (global.player_score_mtp == 2)
{
    if (argument0)
    {
        var _score;
...
else if (global.player_score_mtp == 3)
{
    if (argument0)
    {
        var _score;
...
else if (global.player_score_mtp > 3 && global.player_score_mtp < 16)
{
    if (argument0)
    {
        var _score;
...
else if (global.player_score_mtp > 15)
{
    if (argument0)
    {
        var _score;
